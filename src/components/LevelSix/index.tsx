...
import { ArrayAdventure } from './ArrayAdventure';
...
const locations = [
  { id: 1, name: 'Array Quiz', icon: Terminal },
  { id: 2, name: 'Code Scramble', icon: Code },
  { id: 3, name: 'Array Game', icon: Book }
];

export const LevelSix: React.FC = () => {
  ...
  const handleContinueAfterMiniGame = () => {
    ...
    updateProgress({
      ...
      completedLevels: [...new Set([...userProgress.completedLevels, 6])],
      currentLevel: Math.max(userProgress.currentLevel, 7)
    });
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {!gameStarted && !showMiniGame && (
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8">
            <h1 className="text-3xl font-bold text-white mb-6">Level 6: Mastering Arrays in C</h1>
        ...
        {gameStarted && !showMiniGame && !showCongratulations && (
          <div className="space-y-8">
            ...
            {currentLocation === 0 && (
              <ArrayQuiz onComplete={handleChallengeComplete} />
            )}
        ...
        {showMiniGame && !showCongratulations && (
          <ArrayAdventure onComplete={handleMiniGameComplete} />
        )}

        {showCongratulations && (
          <Congratulations
            title="Level Complete!"
            message="You've mastered arrays in C programming!"

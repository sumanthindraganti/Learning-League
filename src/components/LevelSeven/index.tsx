...
import { CodeScramble } from './CodeScramble';
import { TicTacToe } from './TicTacToe';
import { Congratulations } from '../Congratulations';
import { useUser } from '../../context/UserContext';

const locations = [
  { id: 1, name: 'Function Quiz', icon: Code },
  { id: 2, name: 'Code Scramble', icon: Book }
];

export const LevelSeven: React.FC = () => {
  ...
  const handleContinueAfterMiniGame = () => {
    ...
    updateProgress({
      ...
      completedLevels: [...new Set([...userProgress.completedLevels, 7])],
      currentLevel: Math.max(userProgress.currentLevel, 8)
    });
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {!gameStarted && !showMiniGame && (
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8">
            <h1 className="text-3xl font-bold text-white mb-6">Level 7: Functions in C</h1>
            
            <div className="aspect-video mb-8 bg-black/30 rounded-lg">
              <div className="flex items-center justify-center h-full text-white/50">
                <iframe 
                  className="w-full h-full rounded-lg"
                  src="https://www.youtube.com/embed/f--fD8Y0RnA"
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside text-white/70 space-y-2">
                ...
                <li>Function declaration vs. definition</li>
                <li>Parameter passing: Call by Value vs. Call by Reference</li>
        ...
        {gameStarted && !showMiniGame && !showCongratulations && (
          <div className="space-y-8">
            ...
            {currentLocation === 0 && (
              <FunctionQuiz onComplete={handleChallengeComplete} />
            )}
            
            {currentLocation === 1 && (
              <CodeScramble onComplete={handleChallengeComplete} />
            )}
          </div>
        )}

        {showMiniGame && !showCongratulations && (
          <TicTacToe onComplete={handleMiniGameComplete} />
        )}

        {showCongratulations && (
          <Congratulations
            title="Level Complete!"
            message="You've mastered functions in C programming!"
